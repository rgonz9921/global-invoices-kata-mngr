...
import com.project_kata.global_invoices_kata_mngr.infrastructure.config.CorsProperties;
 ...
 * <p>Las reglas de autorizacion por rol sobre endpoints de factura llegan en el Incremento 3;
 * aqui solo se abre {@code /api/v1/auth/**} y {@code /actuator/health}, el resto exige autenticacion.
 */
@Configuration
@EnableWebSecurity
